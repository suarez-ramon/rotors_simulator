...
void GazeboWindGustPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
  ...
  getSdfParam<math::Vector3>(_sdf, "windGustDirection0", wind_gust_direction0_,
  ...
  getSdfParam<math::Vector3>(_sdf, "windGustDirection1", wind_gust_direction1_,
  ...
  getSdfParam<math::Vector3>(_sdf, "windGustDirection2", wind_gust_direction2_,
  ...
  getSdfParam<math::Vector3>(_sdf, "windGustDirection3", wind_gust_direction3_,
  ...
  getSdfParam<math::Vector3>(_sdf, "windGustDirection4", wind_gust_direction4_,
  ...
  getSdfParam<math::Vector3>(_sdf, "windGustDirection5", wind_gust_direction5_,
