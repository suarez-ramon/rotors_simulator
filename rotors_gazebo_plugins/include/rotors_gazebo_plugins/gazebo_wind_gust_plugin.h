...
static const math::Vector3 kDefaultWindGustDirection0 = math::Vector3(0, 1, 0);
static const math::Vector3 kDefaultWindGustDirection1 = math::Vector3(0, 1, 0);
static const math::Vector3 kDefaultWindGustDirection2 = math::Vector3(0, 1, 0);
static const math::Vector3 kDefaultWindGustDirection3 = math::Vector3(0, 1, 0);
static const math::Vector3 kDefaultWindGustDirection4 = math::Vector3(0, 1, 0);
static const math::Vector3 kDefaultWindGustDirection5 = math::Vector3(0, 1, 0);
...
class GazeboWindGustPlugin : public ModelPlugin {
 ...
 private:
  ...
  math::Vector3 wind_gust_direction0_;
  math::Vector3 wind_gust_direction1_;
  math::Vector3 wind_gust_direction2_;
  math::Vector3 wind_gust_direction3_;
  math::Vector3 wind_gust_direction4_;
  math::Vector3 wind_gust_direction5_;
